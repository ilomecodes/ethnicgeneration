  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center" style={{ background: "#f6f1e6" }}>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
        <Link
          href="/"
          className="flex items-center justify-center gap-2 px-8 py-4 rounded-2xl text-sm font-semibold w-full sm:w-auto"
          style={{ background: "#14110d", color: "#f6f1e6", fontFamily: "var(--font-nav)" }}
        >
          <ArrowLeft size={15} />
        ...
        <a
          href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
            `Bonjour, je viens d'envoyer une demande sur mesure${nom ? ` (${nom})` : ""} sur Ethnicgeneration et j'aimerais en discuter.`
          )}`}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 px-8 py-4 rounded-2xl text-sm font-semibold w-full sm:w-auto"
          style={{ background: "#25D366", color: "#fff", fontFamily: "var(--font-nav)" }}
        >
