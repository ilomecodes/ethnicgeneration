  ...
  return (
    <div className="space-y-6">
      <div className="flex items-end justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-gray-800">Tarifs de livraison</h1>
      ...
      <div className="grid grid-cols-3 gap-5">
        {zones.map((zone) => {
          ...
          return (
            <div key={zone} className="bg-white rounded-2xl p-5 shadow-sm">
            ...
            {rates.map((rate) => {
              ...
              return (
                <tr key={rate.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700 font-medium">{rate.carrier}</td>
                  <td className="px-6 py-4 text-sm text-gray-500">{rate.minWeight}</td>
                  <td className="px-6 py-4 text-sm text-gray-500">{rate.maxWeight}</td>
                  <td className="px-6 py-4 text-sm font-bold text-gray-800">{rate.price}</td>
                  <td className="px-6 py-4 text-sm text-gray-400">{rate.delay}</td>
                  <td className="px-6 py-4">
