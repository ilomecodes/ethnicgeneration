...
export default function SurMesureAdminPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold" style={{ color: "#14110d" }}>Sur Mesure</h1>
        ...
        {STATUS_PIPELINE.map((status) => {
          ...
          return (
            <div key={status} className="bg-white rounded-2xl p-4 shadow-sm">
              <p className="text-2xl font-bold" style={{ color: "#14110d" }}>{counts[status] ?? 0}</p>
              <span
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold" style={{ color: "#14110d" }}>#{req.id}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{req.piece}</td>
                  <td className="px-6 py-4 text-sm text-gray-500">{req.wax}</td>
                  <td className="px-6 py-4 text-sm text-gray-400">{req.date}</td>
                  <td className="px-6 py-4 text-sm font-semibold" style={{ color: "#b08a4a" }}>
